...
SWIGEXPORT void _wrap_sort__SWIG_1(SwigArrayWrapper *farg1) {
  ...
  arg1 = static_cast< int * >(farg1->data);
  arg2 = farg1->size;
  sort< int >(arg1,arg2);
...
SWIGEXPORT double _wrap_cpp_sum(SwigArrayWrapper *farg1) {
  double fresult ;
  double *arg1 = (double *) 0 ;
  size_t arg2 ;
  double result;
  ...
  arg1 = static_cast< double * >(farg1->data);
  arg2 = farg1->size;
  result = (double)cpp_sum< double >((double const *)arg1,arg2);
  fresult = static_cast< double >(result);
  return fresult;
}


SWIGEXPORT int _wrap_find_sorted(SwigArrayWrapper *farg1, int const *farg3) {
  int fresult ;
  int *arg1 = (int *) 0 ;
  size_t arg2 ;
  int arg3 ;
